...
function Home() {
  const t = labels.ar
  return (
    <div style={{ padding: '24px 16px 120px', minHeight: '100vh', direction: 'rtl' }}>
      <div style={{ textAlign: 'center', padding: '40px 20px 30px' }}>
        <div style={{ fontSize: 48, marginBottom: 12 }}>🏥</div>
        <h1 style={{ fontSize: 28, fontWeight: 900, color: '#fff', marginBottom: 8 }}>{t.title}</h1>
      ...
      <footer style={{ position: 'fixed', bottom: 0, left: 0, width: '100%', padding: '15px', background: '#0f172a', borderTop: '1px solid #1e3a5f', textAlign: 'center', color: '#94a3b8', fontSize: 12, zIndex: 1000 }}>
